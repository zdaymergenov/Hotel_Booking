const l={name:"local-uniform-bit",vertex:{header:`
        ...
        `}};class a{constructor(){this.batcherName="default",this.topology="triangle-list",this.attributeSize=4,this.indexSize=6,this.packAsQuad=!0,this.roundPixels=0,this._attributeStart=0,this._batcher=null,this._batch=null;}get blendMode(){return this.renderable.groupBlendMode}get color(){return this.renderable.groupColorAlpha}reset(){this.renderable=null,this.texture=null,this._batcher=null,this._batch=null,this.bounds=null;}}function s(o,r,i){const t=(o>>24&255)/255;r[i++]=(o&255)/255*t,r[i++]=(o>>8&255)/255*t,r[i++]=(o>>16&255)/255*t,r[i++]=t;}

export { a, e, l, n, s };
//# sourceMappingURL=colorToUniform-BWqj7xWF.js.map
