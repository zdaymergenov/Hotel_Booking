import{j as r}from"./index.BoI39RQH.js";import"./helperFunctions.Ck4K-qjq.js";const e="iblIcdfPixelShader",t=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;r.ShadersStoreWGSL[e]||(r.ShadersStoreWGSL[e]=t);const c={name:e,shader:t};export{c as iblIcdfPixelShaderWGSL};
//# sourceMappingURL=iblIcdf.fragment.12bprPG9.js.map
